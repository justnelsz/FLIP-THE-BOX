...
class CarGame implements ActionListener {
    ...
    private int moves = 0, missed = 0, score = 0;
    ...
    private void loadImages() {
        ...
        for (int i = 1; i <= 10; i++) {
            String imagePath = "carimages/c" + i + ".png";
            carImages.add(imagePath);
            carImages.add(imagePath);
        }
        Collections.shuffle(carImages);
    }
    ...
    private void setupGameBoard() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            String imagePath = carImages.get(i);
    ...
    private void startTimer() {
        ...
        },0, 1200); // Update every 100 milliseconds
    }
...
public void actionPerformed(ActionEvent e) {
    ...
    if (firstCard == null) {
        ...
        matchCheckTimer.schedule(new TimerTask() {
            public void run() {
                if (firstCard.equals(secondCard)) {
                    firstButton.removeActionListener(CarGame.this);
                    secondButton.removeActionListener(CarGame.this);
                    score += 10; // points
        ...
        }, 900); // Delay before checking match
