...
class FoodGame implements ActionListener {
    ...
    private void loadImages() {
        ...
        for (int i = 1; i <= 10; i++) {
            String imagePath = "foodimages/f" + i + ".png";
            foodImages.add(imagePath);
            foodImages.add(imagePath);
        }
        Collections.shuffle(foodImages);
    }
        ...
        matchCheckTimer.schedule(new TimerTask() {
            public void run() {
                if (firstCard.equals(secondCard)) {
                    firstButton.removeActionListener(FoodGame.this);
                    secondButton.removeActionListener(FoodGame.this);
                    score += 10; // points
